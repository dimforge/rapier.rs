...
fn modify_collider_groups(mut flags: Query<&mut ColliderFlags>) {
    for mut co_flags in flags.iter_mut() {
        co_flags.collision_groups = InteractionGroups::new(0b1101, 0b0100);
        co_flags.solver_groups = InteractionGroups::new(0b0011, 0b1011);
    }
}
```
...
collider.setSolverGrops(0x000D0004);
```

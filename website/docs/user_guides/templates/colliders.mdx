...
import CreationAndInsertion from './colliders/collider_creation_and_insertion.mdx'

<CreationAndInsertion />

## Collider type
import Type from './colliders/collider_type.mdx'
...
## Mass properties
import MassProperties from './colliders/collider_mass_properties.mdx'

<MassProperties />

## Position
import Position from './colliders/collider_position.mdx'
...
## Friction
import Friction from './colliders/collider_friction.mdx'

<Friction />

## Restitution
import Restitution from './colliders/collider_restitution.mdx'

<Restitution />

## Collision groups and solver groups
import CollisionGroups from './colliders/collider_collision_groups.mdx'

<CollisionGroups />

## Active collision types
import ActiveCollisionTypes from './colliders/collider_active_collision_types.mdx'

<ActiveCollisionTypes />

## Active events
import ActiveEvents from './colliders/collider_active_events.mdx'

<ActiveEvents />

## Active hooks
import ActiveHooks from './colliders/collider_active_hooks.mdx'

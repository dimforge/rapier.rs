...
import CreationAndInsertion from './rigid_bodies/rigid_body_creation_and_insertion.mdx'

<CreationAndInsertion />

## Rigid-body type
import RigidBodyType from './rigid_bodies/rigid_body_type.mdx'

<RigidBodyType />

## Position
import Position from './rigid_bodies/rigid_body_position.mdx'
...
## Velocity
import Velocity from './rigid_bodies/rigid_body_velocity.mdx'

<Velocity />

## Gravity
import Gravity from './rigid_bodies/rigid_body_gravity.mdx'

<Gravity />

## Forces and impulses
import ForcesAndImpulses from './rigid_bodies/rigid_body_forces_and_impulses.mdx'

<ForcesAndImpulses />

## Mass properties
import MassProperties from './rigid_bodies/rigid_body_mass_properties.mdx'

<MassProperties />

## Locking translations/rotations
import Locking from './rigid_bodies/rigid_body_locking_translations_rotations.mdx'

<Locking />

## Damping
import Damping from './rigid_bodies/rigid_body_damping.mdx'

<Damping />

## Dominance
import Dominance from './rigid_bodies/rigid_body_dominance.mdx'

<Dominance />

## Continuous collision detection
import CCD from './rigid_bodies/rigid_body_ccd.mdx'

<CCD />

## Sleeping
import Sleeping from './rigid_bodies/rigid_body_sleeping.mdx'

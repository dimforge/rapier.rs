...
| `bevy_rapier2d::physics::EventQueue` | for collecting the physics events (collision/proximity started/ended). |
...
| `bevy_rapier3d::physics::EventQueue` | for collecting the physics events (collision/proximity started/ended). |

...
| _Pin-slot joint or [groove joint (Godot)](https://docs.godotengine.org/en/stable/classes/class_groovejoint2d.html)_    | 1 Translation + 1 Rotation (along different axes) | 1 Translation + 1 Rotation (along different axes) |
...
| _Pin-slot joint or [groove joint (Godot)](https://docs.godotengine.org/en/stable/classes/class_groovejoint2d.html)_ | `dynamics::PinSlotJoint`    |

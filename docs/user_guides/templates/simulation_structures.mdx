...
An ergonomic `SystemParam` helper is provided to reduce boilerplate:
See https://docs.rs/rapier3d/latest/rapier3d/plugin/context/systemparams/struct.RapierContext.html

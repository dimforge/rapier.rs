...
```rust
<load path='/2d/bevy/examples/colliders2.rs' marker='ColliderPosition1' />
```
```rust
<load path='/2d/bevy/examples/colliders2.rs' marker='ColliderPosition2' />
```
...
```rust
<load path='/3d/bevy/examples/colliders3.rs' marker='ColliderPosition1' />
```
```rust
<load path='/3d/bevy/examples/colliders3.rs' marker='ColliderPosition2' />
```
...
```rust
<load path='/2d/bevy/examples/colliders2.rs' marker='ColliderPosition3' />
```
...
```rust
<load path='/3d/bevy/examples/colliders3.rs' marker='ColliderPosition3' />
```

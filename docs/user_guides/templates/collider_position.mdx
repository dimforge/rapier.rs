...
fn modify_collider_position(mut positions: Query<&mut ColliderPositionComponent>) {
...
```
```rust
fn modify_collider_position_wrt_parent(mut collider_parents: Query<&mut ColliderParentComponent>) {

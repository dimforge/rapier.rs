...
function iframeLoaded() {
  if (typeof document !== "undefined") {
    ...
    if (!(iFrameID instanceof HTMLIFrameElement))
      throw new Error(
        `Expected iFrameID to be an HTMLIFrameElement, was ${
          (iFrameID && iFrameID.constructor && iFrameID.constructor.name) ||
          iFrameID
        }`
      );
    ...
    if (iFrameID.height != newHeight) iFrameID.height = newHeight;
  }
}

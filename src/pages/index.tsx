...
const features = [
  ...
  },
  {
    ...
    description: (
      <>
        Constraint the relative motion of two rigid-bodies using force-based
        joints. Simulate ragdolls, robots, vehicles, etc.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        Use our official NPM packages published behind the&nbsp;
        <a href="https://www.npmjs.com/search?q=%40dimforge">@dimforge</a>
        &nbsp;namespace and run Rapier in any modern browser.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Optionally make Rapier cross-platform deterministic on all IEEE 754-2008
        compliant 32- and 64-bits platforms.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Built with a FOSS mindset, we aim to empower the Rust and web
        communities with an efficient physics simulation framework.
      </>
    ),
  },
];
    ...
    >
      <header className={clsx("hero hero--primary", styles.heroBanner)}>
        <div className="container">
          <div className="">
            <img
              src="img/rapier_logo_color_textpath.svg"
              width="70%"
              alt="Project Logo"
            />
          </div>
